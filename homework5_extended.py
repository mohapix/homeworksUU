...
dict_elem = input("Введите слово из словаря: ")
if dict_elem in my_dict:
    print("Перевод слова", "'" + dict_elem + "':", my_dict.get(dict_elem))
else:
    my_dict.update({dict_elem: input("Я не знаю такого слова. Напишите его перевод: ")})
    print("-----------------------")
